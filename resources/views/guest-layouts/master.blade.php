...
<head>
    ...
    <link href="{{ asset('theme/css/pages/login/login-3.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{ asset('theme/css/themes/layout/aside/dark.css') }}" rel="stylesheet" type="text/css"/>
    <!--end::Layout Themes-->
